...
struct WorkspaceConnectionHelp: View {
    ...
    private var command: String {
        ...
        return "connectnow start\nconnectnow bridge on\nconnectnow cloud connect --url '" + url + "'" + (model.addressText.hasPrefix("http:") ? " --dev-local" : "")
    }
    var body: some View {
        NavigationStack {
            ScrollView {
