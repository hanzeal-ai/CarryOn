...
class Handler(BaseHTTPRequestHandler):
    ...
    def handle_api(self, method):
        try:
            ...
            path = parsed.path
            if method == "GET" and path in ("/", "/example.html", "/logo.svg", "/favicon.png", "/apple-touch-icon.png", "/app.js", "/subagents.js", "/notification-client.js", "/workspace-binding.js", "/client.js", "/cloud-console-client.js", "/console-login.js", "/qrcode.js", "/timeline.js", "/operations.js", "/style.css", "/shadcn.css", "/shadcn-ui.js", "/mobile.css", "/mobile-ui.js"):
